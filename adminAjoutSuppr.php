	...
	<body>
		<div id="page">
			...
			<div id="contents">
				<div class="background">
					<div id="centre">
						...
						<div id="ajouteOeuvre" align="center">
								<form method="get" action="adminAjoutSuppr.php" >
									<fieldset >
										<table>
					...
					<div  align="center">
							<form method="post" action="adminAjoutSuppr.php" >
								<fieldset >
									<table>
				...
				<?php
			if(isset($_GET['ISBN']) && isset($_GET['TitreOeuvre'])&& isset($_GET['typeOeuvre'])&& isset($_GET['prixAchat'])  && isset($_GET['domaine']) ){
				$isbn=$_GET['ISBN'];
				$titreoeuvre=$_GET['TitreOeuvre'];
				$typeoeuvre=$_GET['typeOeuvre'];
		$resultat2= "INSERT INTO Oeuvre (cote,titreOeuvre,TypeOeuvre) VALUES ('$isbn','$titreoeuvre','$typeoeuvre')" ;
